    ...
    >
      ...
      {imageCrop && cropControlsStyle ? (
        <div className="board-image-crop-actions" style={cropControlsStyle} onPointerDown={(event) => event.stopPropagation()}>
          <button type="button" className="board-image-crop-action board-image-crop-action--confirm" onClick={onConfirmImageCrop} aria-label="Confirm Crop">
            ✓
          </button>
          <button type="button" className="board-image-crop-action board-image-crop-action--cancel" onClick={onCancelImageCrop} aria-label="Cancel Crop">
            ×
          </button>
        </div>
      ) : null}
