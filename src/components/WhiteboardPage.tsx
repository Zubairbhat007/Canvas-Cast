...
function ZoomControls({
  ...
  const lockedFitTitle = locked ? 'View automatically fits recording area during recording' : 'Fit Content';
    ...
    <div className="board-clear-confirm" role="dialog" aria-modal="true" aria-labelledby="board-clear-confirm-title">
      <div className="board-clear-confirm__panel">
        <p id="board-clear-confirm-title" className="board-clear-confirm__title">
          {'Clear all contents of the current whiteboard?'}
        </p>
        <p className="board-clear-confirm__description">{'This action can be undone.'}</p>
...
function SlideNavigator({
  ...
  const lockedTitle = isStructureLocked ? 'Cannot modify slide structure while recording' : undefined;
  ...
  return (
    <aside ref={navigatorRef} className="slide-navigator" aria-label="Slide navigation">
      <div className="slide-navigator__header">
        <h2 className="slide-navigator__title">{`Slides`}</h2>
      </div>
      <div
        ref={listRef}
      ...
      >
        {slides.length === 0 ? (
          ...
          >
            ...
            <span>{`Click here to add the first slide`}</span>
          </button>
